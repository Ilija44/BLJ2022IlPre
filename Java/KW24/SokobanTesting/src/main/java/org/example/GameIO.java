    ...
    private void updateOutput() {
        ...
        for (int x = 0; x < game.getRowCount(); x++) {
            for (int y = 0; y < game.getColCount(); y++) {
                ...
                g2d.setColor(colorMap.get(game.getGameField()[y][x]));
                if (game.getGameField()[y][x] == 3 && game.getGoalsPos().contains(new Point(y, x))) {
                    g2d.setColor(colorMap.get(5));
                }
